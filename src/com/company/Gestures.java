...
public enum Gestures {
    D(0,'D'),P(1,'P'),S(2,'S'),W(3,'W'),C(4,'C'),F(5,'F'),d(6,'d'),p(7,'p'),s(8,'s'),w(9,'w'),nothing(10,'-'),stab(11,'>');

    int gestureIndex;
    char gestureChar;
    public static int doubleOffset = 6;

    public static Gestures[] GESTURES_INDEXED = new Gestures[] { D,P,S,W,C,F,d,p,s,w,nothing,stab };
